...
(defvar doom-themes-base-faces
  '(;; --- custom faces -----------------------
    ...
    ;; (region               :background blue     :foreground bg   :extend t)
    ...
    (mode-line           :background bg     :foreground fg     :distant-foreground bg   :box `(:line-width 2 :color bg-alt))
    ...
    (line-number-current-line
     ...
     :background bg :foreground fg :distant-foreground nil
     :weight 'normal :italic nil :underline nil :strike-through nil)
    ...
    (company-tooltip-selection  :background (doom-blend blue bg 0.20))
    (company-tooltip-mouse      :background blue :foreground bg :distant-foreground fg)
    ...
    (diredfl-dir-heading            :foreground blue :underline t :weight 'semi-bold)
    ...
    (rainbow-delimiters-depth-12-face :foreground green)
    ...
    ;; outline
    (outline-1 :foreground blue                        :extend t)
    (outline-2 :foreground magenta                     :extend t)
    (outline-3 :foreground violet                      :extend t)
    (outline-4 :foreground (doom-lighten blue 0.25)    :extend t)
    (outline-5 :foreground (doom-lighten magenta 0.25) :extend t)
    (outline-6 :foreground (doom-lighten blue 0.5)     :extend t)
    (outline-7 :foreground (doom-lighten magenta 0.5)  :extend t)
    (outline-8 :foreground (doom-lighten blue 0.8)     :extend t)

    ;; org-mode
    (org-archived                 :foreground doc-comments)
    (org-block                    :foreground fg)
    ;; (org-block-background         :background bg :extend t)
    (org-block-begin-line         :foreground comments :background bg-alt :slant 'italic)
    (org-block-end-line           :foreground comments :background bg-alt :slant 'italic)
    (org-checkbox                 :inherit 'org-todo)
    (org-checkbox-statistics-done :foreground comments)
    ...
    (org-document-title           :foreground fg :weight 'semi-bold :family "Lora" :height 1.6)
    ...
    (org-quote                    :family "Lora" :height 1.3 :extend t)
    ...
    (org-roam-dailies-calendar-note :foreground blue :weight 'bold)
