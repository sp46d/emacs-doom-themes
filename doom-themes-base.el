...
(defvar doom-themes-base-faces
  '(;; --- custom faces -----------------------
    ...
    (org-block-begin-line         :foreground comments :underline t :extend nil :slant 'italic)
    (org-block-end-line           :foreground comments :overline t :extend nil :slant 'italic)
    ...
    (org-quote                    :family "Roboto" :height 1.2 :extend t)
