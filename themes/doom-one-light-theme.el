...
(def-doom-theme doom-one-light
  ...
  ((bg         '("#fffff9" nil       nil            ))
   ...
   (base8      '("#002b36" "black"   "black"        ))
   (fg         '("#64787e" "#64787e" "black"        ))
   (fg-alt     '("#c6c7c7" "#c7c7c7" "brightblack"  ))

   (grey       base4)
   (red        '("#dc322f" "#e45649" "red"          ))
   (orange     '("#cb4b16" "#dd8844" "brightred"    ))
   (green      '("#859900" "#50a14f" "green"        ))
   (teal       '("#4db5bd" "#44b9b1" "brightgreen"  ))
   (yellow     '("#b58900" "#986801" "yellow"       ))
   (blue       '("#268bd2" "#4078f2" "brightblue"   ))
   (dark-blue  '("#043c52" "#a0bcf8" "blue"         ))
   (magenta    '("#d33682" "#a626a4" "magenta"      ))
   (violet     '("#6c71c4" "#b751b6" "brightmagenta"))
   (cyan       '("#2aa198" "#0184bc" "brightcyan"   ))
   (dark-cyan  '("#054048" "#005478" "cyan"         ))
