...
(def-doom-theme doom-one
  ...
  ((bg         '("#002b36" nil       nil            ))
   ...
   (dark-blue  '("#043c52" "#2257A0" "blue"         ))
   (magenta    '("#d33682" "#c678dd" "brightmagenta"))
   (violet     '("#6c71c4" "#a9a1e1" "magenta"      ))
   (cyan       '("#2aa198" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#054048" "#5699AF" "cyan"         ))
   ...
   (variables      blue)
   (numbers        orange)
   (region         `(,(doom-lighten (car bg-alt) 0.05) ,@(doom-lighten (cdr base0) 0.3)))
   (error          red)
   (warning        yellow)
   (success        green)
   (vc-modified    orange)
